...
my_Customer = Customer("Nine", "ninekungnapadon@gmail.com", "Nakhon Pathom")
my_OnlineShop = OnlineShop("ECS Store", "https://ee-eng.su.ac.th")

my_Product1 = Product("Wireless Mouse", "A smooth and silent wireless mouse", 1450, my_OnlineShop)
my_Product2 = Product("Mechanical Keyboard", "RGB mechanical keyboard with red switches", 1990, my_OnlineShop)
